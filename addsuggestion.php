...
$category= $_POST['category'];
    ...
    $result = mysql_query("INSERT INTO comments (username,path,pathfull,category, title,message,date ,status) VALUES(' $username','$path','$pathfull','$category', '$title', '$message', '$date','pending')");
